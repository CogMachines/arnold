...
void
parse_modules(vw& all, io_buf& model)
{
...
namespace VW
{
    ...
    char**
    get_argv_from_string(const std::string& s, int& argc)
    {
    ...
    vw*
    initialize(const std::string& inArgs,
               io_buf* model,
               bool skipModelLoad,
    ...
    {
        int argc = 0;
        char** argv = get_argv_from_string(inArgs, argc);
        vw* ret = nullptr;
